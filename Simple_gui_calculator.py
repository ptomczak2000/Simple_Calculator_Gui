...
def button_equal():
    ...
    if math == "addition":
        answer = inputBox.insert(0, f_num + int(second_number))
...
button_cls = Button(root, text="Clear", padx=79, pady=20, command=lambda: button_clear())
...
button_div = Button(root, text="/", padx=41, pady=20, command=button_division)
